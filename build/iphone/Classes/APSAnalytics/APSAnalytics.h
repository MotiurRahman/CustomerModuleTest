 ...
 * to send analytic data that can be viewed on the CustomerModuleTest Dashboard.
 *
 * For information on getting started with CustomerModuleTest Platform Services,
