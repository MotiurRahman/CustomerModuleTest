...
//@interface CustomerModuleTestObject : NSObject
//@end

@interface CustomerModuleTestObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CustomerModuleTestObject class]])
		{
			for (NSString *key in [[(CustomerModuleTestObject*)o modules] allKeys])
			{
