...
//Rare exceptions to indicate a bug in the _customermoduletest code (Eg, function that a subclass should have implemented)
...
/**
 The base class for CustomerModuleTest proxies.
 */
