...
// in simulator we redefine to format for CustomerModuleTest Developer console
...
{\
	NSString * exceptionName = [@"org.customermoduletest." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.customermoduletest";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICustomerModuleTestNativeItemNone = -1, 
	UICustomerModuleTestNativeItemSpinner = -2,
	UICustomerModuleTestNativeItemProgressBar = -3,
	
	UICustomerModuleTestNativeItemSlider = -4,
	UICustomerModuleTestNativeItemSwitch = -5,
	UICustomerModuleTestNativeItemMultiButton = -6,
	UICustomerModuleTestNativeItemSegmented = -7,
	
	UICustomerModuleTestNativeItemTextView = -8,
	UICustomerModuleTestNativeItemTextField = -9,
	UICustomerModuleTestNativeItemSearchBar = -10,
	
	UICustomerModuleTestNativeItemPicker = -11,
	UICustomerModuleTestNativeItemDatePicker = -12,
	
	UICustomerModuleTestNativeItemInfoLight = -13,
	UICustomerModuleTestNativeItemInfoDark = -14,
	
	UICustomerModuleTestNativeItemDisclosure = -15,
	
	UICustomerModuleTestNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CustomerModuleTest instances of
