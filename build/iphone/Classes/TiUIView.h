...
/**
 Base class for all CustomerModuleTest views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the CustomerModuleTest view hierarchy (such as wrapped iOS UIViews) was touched.
