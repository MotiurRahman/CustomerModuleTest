...
@interface CustomerModuleTestObject : KrollCoverageObject {
#else
@interface CustomerModuleTestObject : KrollObject {
#endif
@private
...
extern NSString * CustomerModuleTest$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	CustomerModuleTestObject *_customermoduletest;
    KrollObject* console;
	BOOL shutdown;
